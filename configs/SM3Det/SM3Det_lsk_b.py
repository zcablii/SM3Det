...
model = dict(
    ...
    backbone=dict(
        type='LSKNet_moe_MultiInput',
        MoE_Block_inds_fc1 = [[],[0,2],[i*2 for i in range(6)],[0,2]],
        MoE_Block_inds_fc2 = [[],[0,2],[i*2 for i in range(6)],[0,2]],
        datasets=None,
        num_experts= 4, 
        top_k= 2,
        ...
        init_cfg=dict(type='Pretrained', checkpoint="../data/pretrained/lsk_b_backbone.pth.tar")),
    neck=dict(
        type='MultitaskFPN',
