...
ds_collections = {
    'DOTA': {
        'root' : '../../InternRS_data/val_annos/obb_rgb_dota_test.jsonl',
        'max_new_tokens': 1000,
        'min_new_tokens': 1,
        'type': 'test',
    ...
    'FAIR1M2': {
        'root' : '../../InternRS_data/val_annos/obb_rgb_fair1m2_test.jsonl',
        'max_new_tokens': 1000,
        'min_new_tokens': 1,
        'type': 'test',
        'image_root' : '../../InternRS_data/',
    ...
    'RSAR': {
        'root' : '../../InternRS_data/val_annos/obb_sar_rsar_test.jsonl',
        'max_new_tokens': 1000,
        'min_new_tokens': 1,
        'type': 'test',
        'image_root' : '../../InternRS_data/',
    ...
    'SRSDD': {
        'root' : '../../InternRS_data/val_annos/obb_sar_srsdd_test.jsonl',
        'max_new_tokens': 1000,
        'min_new_tokens': 1,
        'type': 'test',
        'image_root' : '../../InternRS_data/',
...
class GroundingDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        question = data_item['conversations'][0]['value']#self.prompt
        answer = data_item['conversations'][1]
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        outputs = []
        for _, (pixel_values, questions, answers, image_names,num_patches_list) in tqdm(enumerate(dataloader)):
            ...
            # print(questions)
            if ds_collections[ds_name]['batch_size']>1:
                # print(pixel_values.shape[0])
                # num_patches_list=[]
                # print(pixel_values)
                # for i in range(len(questions)):
                #     num_patches_list.append(pixel_values.shape[0]//len(questions))
